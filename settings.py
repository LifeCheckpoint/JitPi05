...
JITRL_OUTPUT_DIR = OUTPUT_DIR / "jitrl_eval_task65_seed17_full_jitrl"
MAX_PLAN_TOKENS = 20
TOP_K = 5
SEED = 7
SIM_EPISODES = 5
...
JITRL_REWARD_VERSION = "vlm_step_score_div3_terminal_plus1_v1"
JITRL_BOOTSTRAP_SAMPLES = 10_000
JITRL_BOOTSTRAP_CONFIDENCE = 0.95
JITRL_TASK = {
    "name": "libero_90_task65",
    "suite": "libero_90",
    "task_id": 65,
    "max_steps": 400,
    "zero_shot": True,
