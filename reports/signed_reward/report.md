...
核心实验配置位于 [`config.py`](../../src/jitpi05/config.py)，在线闭环位于 [`rollout.py`](../../src/jitpi05/jitrl/rollout.py)，多任务入口和汇总分别位于 [`jitrl.py`](../../src/jitpi05/cli/jitrl.py) 与 [`metrics.py`](../../src/jitpi05/jitrl/metrics.py)。
