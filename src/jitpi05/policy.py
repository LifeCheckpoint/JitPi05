...
from jitpi05.config import ORACLE_SUBTASK, PI05_ID, PI05_TOKENIZER_ID, SEED
...
def run_pi05_comparison(
    ...
    preprocessor, postprocessor = make_pi05_processors(
        config, dataset.meta.stats, "cuda"
    )
    ...
    return (
        actions,
        {"conditions": conditions, "metrics": metrics, "traces": traces},
        initial_noise.cpu(),
    )
